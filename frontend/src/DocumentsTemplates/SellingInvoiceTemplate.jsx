...
function SellingInvoiceTemplate(InvoiceData) {
    ...
    <body>
      ...
      <div class="invoice-container">
        <div class="invoice-details">
          ...
          <p>اسم العميل: ${InvoiceData.Client_Name}</p>
        </div>
          ...
          <table style="width: 100%; border-collapse: collapse;">
            <thead>
              <tr>
                ...
                <th style="border: 1px solid #ddd; padding: 8px;">المحول للحساب</th>
              </tr>
            </thead>
            <tbody>
              <tr>
...
export default SellingInvoiceTemplate;